...
def car_attr_init():
    ...
    attr_num = 16
    # device = cfg.device
    model_path = "exp_result/PA100k/PA100k/img_model/car_attr18_20210512.pth"
...
def model_transform(model):
    # model.cuda()
    torch.save(model.state_dict(),"car_attr18_20210512.pt", _use_new_zipfile_serialization=False)
