...
from dataset.AttrDatasethh import AttrDataset, get_transform
...
def main(args):
    ...
    save_model_path = os.path.join(model_dir, 'ckpt_hh.pth')
    ...
    train_set = AttrDataset(transform=train_tsfm)
    ...
    valid_set = AttrDataset( transform=valid_tsfm)
    ...
    classifier = BaseClassifier(nattr=3)
